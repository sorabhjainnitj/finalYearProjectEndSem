				...
				<c:forEach items="${cartLines}" var="cartLine">
						<tr>
							<td data-th="Product">
								...
								<td data-th="Subtotal" id="total_${cartLine.id}" class="text-center">&#8377; ${cartLine.total}</td>
								<td class="actions" data-th="">
									<button class="btn btn-info btn-sm"  name="refreshCart" value="${cartLine.id}"><span class="glyphicon glyphicon-refresh"></span></button>
									<a href="${contextRoot}/cart/${cartLine.id}/delete" class="btn btn-danger btn-sm"  name="cancelCart" value="${cartLine.id}"><span class="glyphicon glyphicon-trash"></span></a>								
								</td>
						</tr>
					</c:forEach>		
					</tbody>
